...
**Current release baseline:** GKOS-2026-08-05 v0.78; R15 allocations are accepted on the v0.79 development line and are not a release claim until a v0.79 release is cut.
...
| `GKOS-RECEIPT-001` | Every committed governed state change MUST be durably bound to a record satisfying the State-Change Receipt role. | Active — v0.79 development line | R15-104, R15-105 | None |
| `GKOS-RECEIPT-002` | The record satisfying the State-Change Receipt role MUST identify the actor class and, where consulted, the deciding deterministic predicate identity/version and whether a non-deterministic checker increased restrictiveness. | Active — v0.79 development line | R15-104 | None |
| `GKOS-RECEIPT-003` | If required receipt binding cannot be completed, the governed state change MUST fail closed or be verifiably rolled back/compensated before it is represented as committed; the conformance manifest MUST declare the binding mechanism. | Active — v0.79 development line | R15-105 | None |
| `GKOS-POLICY-001` | A deployment-supplied policy or predicate required by GKOS MUST have explicit identity and version and MUST NOT be silently substituted by model inference, undeclared defaults, or implementation-private behavior. | Active — v0.79 development line | R15-103 | None |
| `GKOS-RETENTION-001` | Before deletion or disposition of an archived governed artifact is committed, the implementation MUST consult the applicable deployment-declared hold predicate. | Active — v0.79 development line | R15-114 | None |
| `GKOS-RETENTION-002` | The deletion/disposition record satisfying the State-Change Receipt role MUST bind the hold-predicate identity/version and result. | Active — v0.79 development line | R15-114 | None |
| `GKOS-RETENTION-003` | An unavailable or indeterminate mandatory hold evaluation, or a detected hold/erasure conflict, MUST fail closed and be routed for authorized human disposition; GKOS does not itself decide the applicable legal obligation. | Active — v0.79 development line | R15-114 | None |
| `GKOS-REENTRY-001` | Reintroduced formerly managed material MUST enter as a new Layer-1 source and MUST NOT be merged in place into its predecessor. | Active — v0.79 development line | R15-106 | None |
| `GKOS-REENTRY-002` | A re-entered source MUST NOT inherit predecessor layer standing, decisions, epistemic state, authority, context authorization, or authorized-use standing. | Active — v0.79 development line | R15-106 | None |
| `GKOS-REENTRY-003` | Re-entry itself MUST NOT mutate or destroy the predecessor; subsequent retention, erasure, or disposition is a separately governed operation. | Active — v0.79 development line | R15-107 | None |
| `GKOS-REENTRY-004` | Semantic supersession on re-entry MUST be explicitly declared by an authorized human or valid bounded delegation and MUST NOT be inferred by software. | Active — v0.79 development line | R15-108 | None |
| `GKOS-DELEGATION-001` | A supersession delegation MUST be explicit, bounded, versioned, expiring, and no broader or longer-lived than its originating authority, and MUST bind to the applicable Specialized Agent Contract or equivalent governed actor contract. | Active — v0.79 development line | R15-110 | None |
| `GKOS-DELEGATION-002` | A delegated supersession operation MUST be positively classified as routine by a deterministic, human-governed, versioned predicate; major or indeterminate outcomes require prior human disposition. | Active — v0.79 development line | R15-110 | None |
| `GKOS-DELEGATION-003` | A non-deterministic checker MAY only increase restrictiveness and MUST NOT downgrade a deterministic major or indeterminate outcome. | Active — v0.79 development line | R15-110 | None |
| `GKOS-DELEGATION-004` | A delegated action MUST reference its grant and predicate in the record satisfying the State-Change Receipt role and MUST enter the required human-review lifecycle. | Active — v0.79 development line | R15-110 | None |
| `GKOS-DELEGATION-005` | Bounded supersession delegation MUST NOT confer or imply general governed write authority. | Active — v0.79 development line | R15-110 | None |
| `GKOS-DELEGATION-006` | When required review of actions under a delegation becomes overdue, that delegation MUST NOT authorize additional state changes until the overdue condition is dispositioned or a higher-precedence, bounded exception is explicitly authorized, time-limited, and durably receipted. | Active — v0.79 development line | R15-110 | None |
