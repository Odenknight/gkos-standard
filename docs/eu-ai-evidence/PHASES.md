...
| P1 | [Proposal](P1_PROPOSAL.md); [P1.1 spec](specs/01-valid-dossier-and-revisions.md); owner authorised P1.1 implementation only, preserving original logic | [P1.1 implementation and evidence commit `7a04313`](https://github.com/mariusTalpos/gkos-standard/commit/7a04313308ed049be5192e8e8d7d88726efd9af2); [run coordinates and assertions](../../conformance/evidence/eu-ai-p1.1-20260907/run-02/results.json) bind actual file contents | [P1.1 observer and test commit `07f13e8`](https://github.com/mariusTalpos/GKOS-Engine/commit/07f13e810aed23dd66cf843ed39b5c214f10b021); bundle/source hashes in the same run coordinates | Two Node 24.19.0 processes reproduced 10/11 acceptance passes; P11-08 remains FAIL. Original logic unchanged. [Verification](../../conformance/evidence/eu-ai-p1.1-20260907/verification.json) records compatibility failures and skips. No independent review or P1 completion. |
...
| 2026-09-07 | Owner authorised publication to both forks on planning/eu-ai-evidence. Implementation commits are linked in the evidence register. Frozen reports retain their original pre-commit run coordinates and dirty-worktree disclosures; their captured bytes and checksums are preserved. Publication does not change the failed results or acceptance status. |
